...
const Messages = (props) => {
    ...
    ( <>
            {messages && conversation && !loading ? ( <>
                    ...
                    UserAvatar username = { props.conservant.username }
                    height = { 30 }
                    width = { 30 }
                    /> <
                    Typography >
                    ...
                    <
                    Stack sx = {
                        { padding: 2, overflowY: "auto", maxHeight: "100%" }
                    }
                    ...
                    messages.map((message, i) => ( <
                        Message conservant = { props.conservant }
                        message = { message }
                        key = { i }
                        />
                    ))
    ...
    /> <
    Typography variant = "h5" > Ben 's Social Messenger</Typography> <
    Typography color = "text.secondary" >
    Privately message other users on Ben 's Social < /
    Typography > <
    /Stack>
);
};
